...
class SMPLX(object):
    def __init__(self):
        ...
        _create_kwargs = dict(use_pca=False, use_face_contour=True, **self.layer_arg)
        if getattr(cfg, 'egowholebody_flat_hand_mean', False):
            _create_kwargs['flat_hand_mean'] = True
