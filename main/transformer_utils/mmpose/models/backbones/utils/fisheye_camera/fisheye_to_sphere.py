...
class Fisheye2Sphere:
    ...
    def get_pixel_from_image(self, image, patch_coordinate_list):
        for image_i, patch in enumerate(patch_coordinate_list):
            ...
            out_path = r'/home/cv1/works/egowholemocap/mmpose/utils/fisheye_camera/img_%03d.jpg' % image_i
...
if __name__ == '__main__':
    fisheye2sphere = Fisheye2Sphere(
        r'/home/cv1/works/egowholemocap/mmpose/utils/fisheye_camera/fisheye.calibration_01_12.json')
    ...
    image = cv2.imread(r'/media/cv1/SeagateHDD2TB/EgoWholeMocap/render_people_adanna/2hand Idle/img/000001.jpg')
