...
class ViT(BaseBackbone):
    ...
    def __init__(self,
                 ...
                 frozen_stages=-1, ratio=1, last_norm=True, use_lora = False,
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, use_lora = use_lora
            )
    ...
    def forward(self, x):
        x , task_tokens= self.forward_features(x)
        return x, task_tokens
