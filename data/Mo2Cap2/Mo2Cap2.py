...
mapping_indices = [
    7, 9, 11, 13,  # neck, R-shoulder, R-elbow, R-wrist
    8, 10, 12,     # L-shoulder, L-elbow, L-wrist
    2, 4, 6, 19,   # R-hip, R-knee, R-ankle, R-foot
    1, 3, 5, 16    # L-hip, L-knee, L-ankle, L-foot
]

class Mo2Cap2(HumanDataset):
        ...
        if self.use_cache and osp.exists(self.annot_path_cache):
            ...
            for img_path, bbox, kp3d, kp3d_mask in zip(
                ...
                self.datalist.append({
                    ...
                    'keypoints3d_norm': kp3d_normalized.astype(np.float32),  # ✅ 추가
            ...
            self.visualize_img_and_joint_separate(sample_idx = 1000)
