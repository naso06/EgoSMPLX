...
class PseudoGTDataset_Test(HumanDataset):
  
    def __init__(self, transform, data_split, data_dir='/media/cv1/SeagateHDD2TB/EgoPW/human_data_test_smplx',
                 id_roster=None, return_id_onehot=False, use_cache=False):
        super(PseudoGTDataset_Test, self).__init__(transform, data_split)
        ...
        for full_img, bbox, kp2d, kp2d_mask, kp3d, kp3d_mask, smplx_d in zip(
            ...
            item = {
                ...
                'smplx_param': {
                    ...
                    'body_pose': smplx_d.get('body_pose', np.zeros((69,))).reshape(21, 3),
                    ...
                    'expr':      smplx_d.get('expression', np.zeros((10,), dtype=np.float32)),
                },
