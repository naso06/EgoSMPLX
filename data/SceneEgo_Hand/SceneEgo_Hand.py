...
class SceneEgo_Hand(HumanDataset):
    def __init__(self, transform, data_split):
        super(SceneEgo_Hand, self).__init__(transform, data_split)

        # 경로 설정
        self.data_dir = '/media/cv1/SeagateHDD2TB/SceneEgo_test/human_data_test_w_hand'
